...
```js
// Solucion
function calcularEdad(anoDeNacimiento, anoActual) {
  let edad = anoActual - anoDeNacimiento;
  alert(`Tienes ${edad} años`);
}

let anoDeNacimiento = parseInt(prompt("Ingresa tu año de nacimiento"));
let anoActual = parseInt(prompt("Ingresa el año actual"));
calcularEdad(anoDeNacimiento, anoActual);
```
...
```js
// Solucion
function cambiarTextoAMinusculas(texto) {
  alert(texto.toLowerCase());
}

let texto = prompt("Ingresa un texto");
cambiarTextoAMinusculas(texto);
```
...
```js
// Solucion
function cambiarTextoAMayusculas(texto) {
  alert(texto.toUpperCase());
}

let texto = prompt("Ingresa un texto");
cambiarTextoAMayusculas(texto);
```
...
```js
// Solucion
function identificarOperador(operador) {
  let nombreOperador = "";
  if (operador === "+") {
    nombreOperador = "suma";
  } else if (operador === "-") {
  ...
  alert(`El operador es ${nombreOperador}`);
}

let operador = prompt("Ingresa un operador matemático (+, -, *, /)");
...
let precioConIVA = agregarIVA(precio);
...
let largo = parseInt(prompt("Ingresa el largo del rectangulo"));
let ancho = parseInt(prompt("Ingresa el ancho del rectangulo"));
let area = calcularAreaRectangulo(largo, ancho);
...
let esNumero = validarSiEsNumero(valor);
alert(`El valor ingresado es un número: ${esNumero}`);
```
...
```js
// Solucion
function validarCantidadDeCaracteres(texto, cantidad) {
  return texto.length === cantidad;
}

let texto = prompt("Ingresa un texto");
let cantidad = parseInt(prompt("Ingresa la cantidad de caracteres esperada"));
let esLaCantidadEsperada = validarCantidadDeCaracteres(texto, cantidad);
alert(`El texto tiene la cantidad de caracteres esperada: ${esLaCantidadEsperada}`);
```
...
```js
// Solucion
function devolverComoArray(valor1, valor2, valor3) {
  return [valor1, valor2, valor3];
}

let valor1 = prompt("Ingresa un valor");
let valor2 = prompt("Ingresa otro valor");
let valor3 = prompt("Ingresa un tercer valor");
let arrayDeValores = devolverComoArray(valor1, valor2, valor3);
...
```js
// Solucion
function devolverNumeroAleatorio(numeroMaximo) {
  return Math.random() * numeroMaximo;
}

let numeroMaximo = parseInt(prompt("Ingresa un número"));
let numeroAleatorio = devolverNumeroAleatorio(numeroMaximo);
...
```js
// Solucion
function devolverArrayDeNumerosAleatorios(cantidad) {
  let array = [];
...
let cantidad = parseInt(prompt("Ingresa la cantidad de números aleatorios"));
let arrayDeNumerosAleatorios = devolverArrayDeNumerosAleatorios(cantidad);

for (numero of arrayDeNumerosAleatorios) {
  alert(numero);
}
```
